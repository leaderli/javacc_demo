/* DemoTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. DemoTokenManager.java */
package io.leaderli.c1;
import java.io.*;

/** Token Manager. */
@SuppressWarnings ("unused")
public class DemoTokenManager implements DemoConstants {
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public DemoTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public DemoTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
